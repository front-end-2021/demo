            ...
            <div className="layout-page">
              <UserContext.Provider value={{ person, setPerson }} >
                ...
                <div className="content-wrapper">
                  ...
                  {layout == router.Home && <HomeContent />}
                  {layout == router.LayoutWithoutMenu && <LayoutWithoutMenu />}
                  {layout == router.LayoutWithoutNavbar && <LayoutWithoutNavbar />}
                  {layout == router.LayoutWithContainer && <LayoutWithContainer />}
                  {layout == router.LayoutWithFluid && <LayoutWithFluid />}
                  {layout == router.LayoutWithBlank && <h4 className="fw-bold p-4">Blank Page</h4>}
                  {(layout == router.AccountSettingsAccount ||
                    layout == router.AccountSettingsNotify ||
                    layout == router.AccountSettingsConnect) && <AccountSettings />}
