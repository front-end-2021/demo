        ...
        <div className="container-xxl">
            <div className="authentication-wrapper authentication-basic container-p-y">
                <div className="authentication-inner">
                    <div className="card">
                        {type == 1 && <AuthLoginBasic setType={setType} />}
                        {type == 2 && <AuthRegisterBasic setType={setType} />}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className="card-body">
            ...
            <p className="text-center">
                ...
                <a href="#auth-register-basic"
                    onClick={e => setType(2)}><span>Create an account</span></a>
            </p>
        </div>
    )
}
        ...
        <div className="card-body">
            ...
            <p className="text-center">
                ...
                <a href="#auth-login-basic"
                    onClick={e => setType(1)}><span>Sign in instead</span>
                </a>
            </p>
        </div>
    )
