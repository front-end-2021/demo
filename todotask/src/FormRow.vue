    ...
    <form>
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base/7 font-semibold text-gray-900">Form</h2>

                <div class="mt-10 flex flex-col gap-y-2">
                    <div class="flex gap-x-10 items-center">
                        <label for="username" class="w-[80px] block text-sm/6 font-medium text-gray-900">Name</label>
                        <div class="w-full">
                            <div
                    ...
                    <div class="flex gap-x-10 items-center">
                        <div class="w-[80px] block text-sm/6 font-medium text-gray-900">Parent</div>
                        <DropdownSingle :src="availParents" :value="parent" placeholder="Select parent"
                            :setValue="setParent" />
                    </div>
                    <div class="flex gap-x-10 items-center">
                        <div class="w-[80px] block text-sm/6 font-medium text-gray-900">Task type</div>
                        <DropdownSingle :src="availTypes" :value="taskType" placeholder="Select type"
                            :setValue="setTaskType" />
                    </div>
                    <div class="flex gap-x-10">
                        <label for="about" class="w-[80px] block text-sm/6 font-medium text-gray-900 mt-2">About</label>
...
const availParents = computed(() => {
    ...
    ignoreIds.add($nodeItem.value.Id);
...
const availTypes = computed(() => {
    ...
    if (!parent.value) return lsType
    return lsType.filter(x => x.Id != parent.value.TypeId)
});
