# Run development
## Start server api
1. Go to folder: [/goal-action-api/](https://github.com/front-end-2021/demo/tree/main/goal-action-api)
2. Run server use command: ```npm run dev```
...
See the section about <a href="https://facebook.github.io/create-react-app/docs/running-tests">running tests</a>
